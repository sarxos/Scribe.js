(function () {
    ...
    if (!dateformat.masks.scribe) {
        dateformat.masks.scribe = 'yyyy-mm-dd HH:MM:ss';
    }
    ...
    var getLocation = function () {
        ...
        result.func = st.getFunctionName() || 'anonymous'
    ...
    var buildFileInfos = function (infos, fileColors, lineColors) {
        ...
        return {
            msg       : '[' + applyColors(infos.func, fileColors) + '@' +
